...
ActiveRecord::Schema[7.0].define(version: 2022_11_12_222936) do
  ...
  create_table "pings", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.boolean "active", default: false, null: false
    t.index ["team_id"], name: "index_pings_on_team_id"
    t.index ["user_id"], name: "index_pings_on_user_id"
  end

  create_table "pongs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
